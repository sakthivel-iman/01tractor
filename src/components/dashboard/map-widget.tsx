...
export default function MapWidget({ position }: MapWidgetProps) {
  ...
  return (
    <Card className="h-full flex flex-col">
      ...
      <CardContent className="flex-grow rounded-b-xl overflow-hidden p-0">
        {apiKey ? (
          ...
          <div className="h-full min-h-[250px] w-full flex flex-col items-center justify-center bg-muted rounded-b-xl">
